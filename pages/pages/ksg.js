                    ...
                    <div className={styles.fs}>
                        ...
                        <div className={styles.content}>
                            ...
                            <div className={styles.preview}>
                                ...
                                <p className={styles.filecreated}><strong>RELEASE </strong> {file.created}</p>
                        ...
                        <div className={styles.content}>
                            <div className={styles.files}>
                                {dataMerch.map((item, index) => {
                                    const fileClass = index === selectedFileMerch ? styles.selectedfile : '';
                                    return (
                                        <div
                                            key={index}
                                            className={`${styles.file} ${fileClass}`}
                                            onClick={() => { setSelectedFileMerch(index); setCurrentFileMerch(index) }}
                                        >
                                            {item.name}
                                        </div>
                                    );
                            ...
                            <div className={styles.preview}>
                                ...
                                <p className={styles.filecreated}><strong>RELEASE </strong> {fileMerch.created}</p>
                                <div className={styles.seperator}></div>
                                <p className={styles.filelink}><strong>LINK </strong> <a href={fileMerch.link}>{fileMerch.name}</a></p>
                                {fileMerch.embed}
                            </div>
                        </div>
                    </div>
