        ...
        <div className={styles.header}>
          <div className={styles.selector}>
            <div className={styles.tab} onClick={() => setCurrentTab(1)}>
              {currentTab == 1 ? (
                <p style={{ borderBottom: "1px solid black" }}>news</p>
              ) : (
                <p>news</p>
              )}
            </div>
            ...
            <div className={styles.tab} onClick={() => setCurrentTab(3)}>
              {currentTab == 3 ? (
                <p style={{ borderBottom: "1px solid black" }}>member</p>
              ) : (
                <p>member</p>
              )}
            </div>
            ...
            <div className={styles.tab} onClick={() => setCurrentTab(4)}>
              {currentTab == 4 ? (
                <p style={{ borderBottom: "1px solid black" }}>contact</p>
              ) : (
                <p>contact</p>
              )}
            </div>
            ...
            <div className={styles.tab} onClick={() => setCurrentTab(5)}>
              {currentTab == 5 ? (
                <p style={{ borderBottom: "1px solid black" }}>shop</p>
              ) : (
                <p>shop</p>
              )}
            </div>
